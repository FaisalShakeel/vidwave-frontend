...
const Dashboard = () => {
  ...
  const getDashboardStatistics = async () => {
    ...
    setError(null);
    try {
      const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/users/dashboard-statistics`, {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Sign in to view your stats and manage your uploads seamlessly.
          </Typography>
        </Box>

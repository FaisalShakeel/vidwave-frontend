    ...
    const fetchMyVideos = async () => {
      ...
      try {
        ...
        if (response.data.success) {
          setYourVideos(response.data.videos);
        } else {
          throw new Error("Failed to fetch your videos. Please try again later.");
        }
      } catch (err) {
        setError(err.message || "An error occurred while fetching your videos.");
      } finally {
        setLoading(false);
      }
    };
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Sign in to manage and view your uploaded content effortlessly.
          </Typography>
        </Box>
        ...
        >
          <Box sx={{ maxWidth: "400px", width: "100%" }}>
            <Box sx={{ textAlign: "center", mb: 5 }}>
              ...
              >
                You need to be logged in to view your uploaded videos.
              </Typography>
            </Box>
